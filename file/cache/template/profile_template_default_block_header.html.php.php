 ...
 * @version 		$Id: header.html.php 6083 2013-06-17 15:48:53Z Raymond_Benc $
 */
...
<?php endif; ?>
<?php if (Phpfox ::getUserParam('friend.link_to_remove_friend_on_profile') && isset ( $this->_aVars['aUser']['is_friend'] ) && $this->_aVars['aUser']['is_friend'] === true): ?>
							<li>
