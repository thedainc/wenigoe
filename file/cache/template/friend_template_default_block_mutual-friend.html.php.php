...
<?php echo Phpfox::getPhrase('friend.mutual_friends_will_be_listed_here'); ?>
</div>
<?php else: ?>
<div class="p_bottom_5" style="position:relative;">
	<a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl(''.$this->_aVars['aUser']['user_name'].'.friend.mutual'); ?>">
<?php if ($this->_aVars['iTotalMutualFriends'] == 1): ?>
<?php echo Phpfox::getPhrase('friend.1_friend_in_common');  else: ?>
<?php echo Phpfox::getPhrase('friend.total_friends_in_common', array('total' => $this->_aVars['iTotalMutualFriends']));  endif; ?>
	</a>
</div>
<div class="block_listing_inline">
	<ul>
<?php if (count((array)$this->_aVars['aMutualFriends'])):  $this->_aPhpfoxVars['iteration']['friend'] = 0;  foreach ((array) $this->_aVars['aMutualFriends'] as $this->_aVars['iKey'] => $this->_aVars['aFriend']):  $this->_aPhpfoxVars['iteration']['friend']++; ?>

		<li><?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aFriend'],'suffix' => '_50_square','max_width' => 32,'max_height' => 32,'class' => 'js_hover_title')); ?></li>	
<?php endforeach; endif; ?>
	</ul>
	<div class="clear"></div>
</div>
