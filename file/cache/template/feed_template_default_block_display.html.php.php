 ...
 * @author  		Raymond Benc
 * @package  		Module_Feed
 * @version 		$Id: display.html.php 5993 2013-06-03 06:39:39Z Miguel_Espinoza $
 */
 
 

 (($sPlugin = Phpfox_Plugin::get('feed.component_block_display_process_header')) ? eval($sPlugin) : false);  if (isset ( $this->_aVars['sActivityFeedHeader'] )): ?>
