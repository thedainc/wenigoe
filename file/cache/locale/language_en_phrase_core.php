...
This setting may lock users out if you force log in by their user names
  ...
  'menu_home' => 'Home<!--<img width="32" height="32" src="http://harlancabinets.com/images/nav_home-icon.gif">-->',
  'submit' => 'Submit',
  'save' => 'Save',
  'delete' => 'Delete',
...
If you set it to zero ("0" without quotes) it will hide every subcategory and a plus sign will show next to the category name, clicking the plus sign will show that category\'s subcategories.
  ...
  'what_s_on_your_mind' => 'Share anything positive here:',
  'currency' => 'Currency',
...
If you disable it extra checks will be added to try to preserve the original name of the file. If an item with the same name already exists the new one will have a number added at the end.</info>',
  ...
  'setting_keep_files_in_server' => '<title>Keep Files In Server</title><info>Set this to TRUE to keep all the files on the server after they have been uploaded to your CDN.</info>',
...
include/setting/htmlpurifier.sett.php.new</info>',
  ...
  'setting_force_secure_site' => '<title>Force HTTS for Logged In Users</title><info>Enable to make all connections secure when a user is logged in. <b>Notice:</b> Your server must have HTTPS support.</info>',
  ...
  'setting_auth_user_via_session' => '<title>Authenticate Users via Satabase Session Log</title><info>If you enable this option we will authenticate users via a database session log.</info>',
...
http://htmlpurifier.org/live/configdoc/plain.html#HTML.Allowed</info>',
  ...
  'menu_video' => 'Videos',
  'menu_videos' => 'Videos',
  'menu_core_51db065326dde_fad58de7366495db4650cfefac2fcd61' => 'Game',
); ?>