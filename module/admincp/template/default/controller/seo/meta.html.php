 ...
 * @author  		Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: meta.html.php 5844 2013-05-09 08:00:59Z Raymond_Benc $
 */
...
<form method="post" action="#" onsubmit="$(this).ajaxCall('admincp.addMeta'); return false;" id="js_meta_form">
	...
	<div class="table">
		...
		<div class="table_right">
			...
			<div class="extra_info">
				Provide the full URL to add your custom element.
			</div>
		</div>
		<div class="clear"></div>
	</div>
	...
	<div class="table">
		...
		<div class="table_right">
			...
			<div class="extra_info">
				If adding keywords make sure to seperate them with commas.
			</div>
		</div>
		<div class="clear"></div>
	</div>	
