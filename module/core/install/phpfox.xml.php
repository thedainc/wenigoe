...
Site Name</setting>
  ...
  1 => '2|core.her|profile.female|core.herself|female',
		...
		<setting group="server_settings" module_id="core" is_hidden="0" type="boolean" var_name="include_master_files" phrase_var_name="setting_include_master_files" ordering="15" version_id="3.6.0rc1">0</setting>
...
If you disable it extra checks will be added to try to preserve the original name of the file. If an item with the same name already exists the new one will have a number added at the end.</info>]]></phrase>
		...
		<phrase module_id="core" version_id="3.5.0beta1" var_name="setting_keep_files_in_server" added="1353415860"><![CDATA[<title>Keep Files In Server</title><info>Set this to TRUE to keep all the files on the server after they have been uploaded to your CDN.</info>]]></phrase>
...
include/setting/htmlpurifier.sett.php.new</info>]]></phrase>
		...
		<phrase module_id="core" version_id="3.6.0rc1" var_name="setting_force_secure_site" added="1371733146"><![CDATA[<title>Force HTTS for Logged In Users</title><info>Enable to make all connections secure when a user is logged in. <b>Notice:</b> Your server must have HTTPS support.</info>]]></phrase>
		...
		<phrase module_id="core" version_id="3.6.0rc1" var_name="setting_auth_user_via_session" added="1371733504"><![CDATA[<title>Authenticate Users via Satabase Session Log</title><info>If you enable this option we will authenticate users via a database session log.</info>]]></phrase>
