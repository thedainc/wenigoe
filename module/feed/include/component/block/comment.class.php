 ...
 * @author  		Raymond Benc
 * @package  		Module_Feed
 * @version 		$Id: comment.class.php 6033 2013-06-10 16:38:03Z Raymond_Benc $
 */
class Feed_Component_Block_Comment extends Phpfox_Component 
{
	...
	public function process()
	{
		...
		$bHasBeenMarked = Phpfox::getService('like')->hasBeenMarked(2, isset($aFeed['type_id']) ? $aFeed['type_id'] : $aFeed['like_type_id'], $aFeed['item_id']);
		
		/* Quick check without the actions*/
		$aFeed['bShowEnterCommentBlock'] = false;
		
		if ( (isset($aFeed['total_like']) && $aFeed['total_like'] > 0 && Phpfox::getParam('like.show_user_photos') == false) ||
