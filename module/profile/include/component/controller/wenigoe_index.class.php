 ...
 * @version 		$Id: index.class.php 6035 2013-06-10 16:59:20Z Raymond_Benc $
 */
class Profile_Component_Controller_Index extends Phpfox_Component 
{
	...
	{	
		...
		$user['user_id'] = Phpfox::getUserId();		
		
		$user['username'] = $wenigoeService->getUsernameById($user['user_id']);
		
		$aLegacy = $wenigoeService->getLegacy($username);
