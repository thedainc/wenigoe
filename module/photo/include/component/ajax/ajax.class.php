 ...
 * @version 		$Id: ajax.class.php 6106 2013-06-21 11:31:52Z Raymond_Benc $
 */
		...
		foreach ($aImages as $iKey => $aImage)
		{
		    ...
		    if ($aImage['completed'] == 'false')
		    {
				...
				if (isset($aPhoto['photo_id']))
				{
				    ...
				    if ((Phpfox::getParam('photo.delete_original_after_resize') || !Phpfox::getParam('core.keep_files_in_server')) && $this->get('is_page') != 1)
				    {
